  ...
  <div>
    ...
    <dialog open>
      <div>
        ...
        <p>Income Trade Asset ("Website"), which includes all products and services offered by Income Trade Asset,
          is and remains the sole property of the Company. All rights are reserved in and for the Company Income Trade Asset
          group is the owner of all the intellectual property rights, including trade names, trademarks, logos
          and the trade names in and are exclusive to Income Trade Asset at all times. Except where expressly stated
          ...
          any materials or media from the Website, without obtaining prior written permission from Income Trade Asset
          Group.</p>
      </div>
      <div>
        <h4>Data</h4>
      ...
      <div>
        <h4>Amendments</h4>
        <p>Income Trade Asset has the right to amend the Agreement without obtaining any prior consent from the Client.
