  ...
  <div class="alpha">
    <div class="body">
      ...
      <div class="row trans-mgt">
        ...
        <div class="form-group fg--search">
          ...
          <input  type="text" class="input" placeholder="Search Contact Messages..." v-model="searchQuery" @input="filterUsers"/>
        </div>
    ...
    <div class="section-5">
      ...
      <div class="empty-state" v-if="this.history.length === 0" >
        ...
        <p class="empty-state-text-2">This is where your user Contact Messages will appear</p>
    ...
    paginatedItems() {
      ...
      const filteredUsers = this.searchQuery.trim() ?
          this.history.filter(user =>
              ...
              user.comment.toLowerCase().includes(this.searchQuery.toLowerCase()) ||
              ...
              user.prefix.toLowerCase().includes(this.searchQuery.toLowerCase()) ||
              user.state.toLowerCase().includes(this.searchQuery.toLowerCase()) ||
              user.topic.toLowerCase().includes(this.searchQuery.toLowerCase()) ||
